					...
					return (
						...
						>
							<SelectTrigger
								...
								className="h-8 w-fit gap-1 border-none bg-transparent px-2 font-medium shadow-none focus:ring-0 focus-visible:ring-0"
							>
								<SelectValue>{() => selected?.label ?? ""}</SelectValue>
							</SelectTrigger>
							<SelectContent className="max-h-60" alignItemWithTrigger={false} align="start">
								{options?.map((opt) => (
